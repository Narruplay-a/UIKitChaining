...
public extension UIView {
    ...
    func sideToSide(_ side: NSLayoutConstraint.Attribute, toView: UIView?, toSide: NSLayoutConstraint.Attribute, offset: CGFloat, relation: NSLayoutConstraint.Relation = .equal, multiplier: CGFloat = 1) {
        ...
        superview.addConstraint(NSLayoutConstraint(item: self, attribute: side, relatedBy: relation, toItem: view, attribute: toSide, multiplier: multiplier, constant: offset))
    }
    
    func setDimension(_ dimension: AKDimension, offset: CGFloat, relation: NSLayoutConstraint.Relation = .equal) {
        guard let _ = self.superview else {
            ConstraintLogger.logSuperviewError(self)
            return }
        addConstraint(NSLayoutConstraint(item: self, attribute: dimension.getAttribute(), relatedBy: relation, toItem: nil, attribute: dimension.getAttribute(), multiplier: 1, constant: offset))
    }
    
    func alignDimension(_ dimension: AKDimension, toView: UIView?, multiplier: CGFloat, offset: CGFloat, relation: NSLayoutConstraint.Relation = .equal) {
        guard let superview = self.superview else {
            ConstraintLogger.logSuperviewError(self)
            return }
        guard let view = toView else {
        ...
        superview.addConstraint(NSLayoutConstraint(item: self, attribute: dimension.getAttribute(), relatedBy: relation, toItem: view, attribute: dimension.getAttribute(), multiplier: multiplier, constant: offset))
    }
    
    func alignVertical(_ view: UIView?, offset: CGFloat) {
        ...
        guard let superview = view.superview else {
            ConstraintLogger.logSuperviewError(self)
            return }
        superview.addConstraint(NSLayoutConstraint(item: self, attribute: NSLayoutConstraint.Attribute.centerX, relatedBy: .equal, toItem: view, attribute: NSLayoutConstraint.Attribute.centerX, multiplier: 1, constant: offset))
    }
    
    func alignVerticalToSuperview(_ offset: CGFloat) {
        guard let superview = self.superview else {
            ConstraintLogger.logError(self, attribute: .centerX)
            return }
        superview.addConstraint(NSLayoutConstraint(item: self, attribute: NSLayoutConstraint.Attribute.centerX, relatedBy: .equal, toItem: superview, attribute: NSLayoutConstraint.Attribute.centerX, multiplier: 1, constant: offset))
    }
    
    func alignHorizontal(_ view: UIView?, offset: CGFloat) {
        guard let view = view else {
        ...
        guard let superview = view.superview else {
            ConstraintLogger.logSuperviewError(self)
            return }
        superview.addConstraint(NSLayoutConstraint(item: self, attribute: NSLayoutConstraint.Attribute.centerY, relatedBy: .equal, toItem: view, attribute: NSLayoutConstraint.Attribute.centerY, multiplier: 1, constant: offset))
    }
    
    func alignHorizontalToSuperview(_ offset: CGFloat) {
        guard let superview = self.superview else {
            ConstraintLogger.logError(self, attribute: .centerY)
            return }
        superview.addConstraint(NSLayoutConstraint(item: self, attribute: NSLayoutConstraint.Attribute.centerY, relatedBy: .equal, toItem: superview, attribute: NSLayoutConstraint.Attribute.centerY, multiplier: 1, constant: offset))
    }
    
    func toTopLayout(_ controller: UIViewController, offset: CGFloat, relation: NSLayoutConstraint.Relation = .equal) {
        controller.view.addConstraint(NSLayoutConstraint(item: self, attribute: NSLayoutConstraint.Attribute.top, relatedBy: relation, toItem: controller.topLayoutGuide, attribute: NSLayoutConstraint.Attribute.bottom, multiplier: 1, constant: offset))
    }
    
    func toBottomLayout(_ controller: UIViewController, offset: CGFloat, relation: NSLayoutConstraint.Relation = .equal) {
        controller.view.addConstraint(NSLayoutConstraint(item: self, attribute: NSLayoutConstraint.Attribute.bottom, relatedBy: relation, toItem: controller.bottomLayoutGuide, attribute: NSLayoutConstraint.Attribute.bottom, multiplier: 1, constant: -offset))
    }
